 ...
 *
 *
 * 2018-02-16: Modified by NYU to correct handling of Mac line endings.
 *
 */
	...
	public function get_row() {
		...
		while (1) {
			...
			if ($state == self::quoted_field) {
				...
				// NYU: If we're not in a quote and we hit a \r without a following \n, that's a Mac line ending.
				if ($state != self::found_quote && !$this->eof && $this->nc != "\n") {
					$row[] = $field;
					return $row;
				}
